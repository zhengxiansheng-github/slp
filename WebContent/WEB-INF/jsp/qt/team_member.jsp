...
<body>
    ...
    <section style="background-image:url(images/banner-news.jpg)" class="banner text-center full_bg">
        <div class="banner-mask">
            <div class="container">
                <h2>团队人员</h2>
                <p><a href="#">创客</a> > <a href="${pageContext.request.contextPath }/teamAction_team">团队人员</a> >  查看内容</p>
            </div>
        </div>
    </section>
    <main class="main">
                ...
                <div class="row">
                    <article class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1">
                        <header class="text-center">
                            ...
                            <div class="info">
                                <small class="date">时间 ${team.createTime}</small><small class="hits">
                                    点击 <span id="hits">${team.count }</span>
                                </small><small class="tags">栏目 ：团队人员</small>
                            </div>
                        </header>
                        <!-- 团队介绍 -->
                        ${team.info }
