            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <form action="${pageContext.request.contextPath }/servicesCategoryAction_search" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="ex_search" name="services.serviceName" value="${services.serviceName }"/>
                                    </div>
                                </div>
			                        ...
			                        <div class="pagination-container">
			                        	<ul class="pagination">
			                        		...
			                        		<c:when test="${currentPage eq 1 }">
			                        			...
			                        			<c:otherwise>
			           		                        <li class="PagedList-skipToNext">
			                        				<a href="${pageContext.request.contextPath}/servicesCategoryAction_search.action?currentPage=${currentPage-1}" rel="up">&lt;&lt;</a>
			                        				</li>             				
			                        			</c:otherwise>
			                        		</c:choose>
			                        		...
			                        		<c:forEach var="index" begin="1" end="${totalPage }">
			                        			<c:choose>
			                        				...
			                        				<li class="active"><a href="${pageContext.request.contextPath}/servicesCategoryAction_search.action?currentPage=${currentPage}">${index}</a></li>
			                        				</c:when>
			                        			
			                        			<c:otherwise>
			                        				<li><a href="${pageContext.request.contextPath}/servicesCategoryAction_search.action?currentPage=${index}">${index}</a></li>
			                        			</c:otherwise>
			                        			</c:choose>
			                        		</c:forEach>
			                        		...
			                        		<c:choose>
			                        			...
			                        			<c:otherwise>
			                        				 <li class="PagedList-skipToNext">
			                        				<a href="${pageContext.request.contextPath}/servicesCategoryAction_search.action?currentPage=${currentPage+1}" rel="next">>></a>
			                        				</li>
			                        			</c:otherwise>
			                        		</c:choose>
