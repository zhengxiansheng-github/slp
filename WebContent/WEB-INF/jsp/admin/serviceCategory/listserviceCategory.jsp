			                        ...
			                        <div class="pagination-container">
			                        	<ul class="pagination">
			                        		...
			                        		<c:when test="${currentPage eq 1 }">
			                        			...
			                        			<c:otherwise>
			           		                        <li class="PagedList-skipToNext">
			                        				<a href="${pageContext.request.contextPath}/servicesCategoryAction_list.action?currentPage=${currentPage-1}" rel="up">&lt;&lt;</a>
			                        				</li>             				
			                        			</c:otherwise>
			                        		</c:choose>
			                        		...
			                        		<c:forEach var="index" begin="1" end="${totalPage }">
			                        			<c:choose>
			                        				...
			                        				<li class="active"><a href="${pageContext.request.contextPath}/servicesCategoryAction_list.action?currentPage=${currentPage}">${index}</a></li>
			                        				</c:when>
			                        			
			                        			<c:otherwise>
			                        				<li><a href="${pageContext.request.contextPath}/servicesCategoryAction_list.action?currentPage=${index}">${index}</a></li>
			                        			</c:otherwise>
			                        			</c:choose>
			                        		</c:forEach>
			                        		...
			                        		<c:choose>
			                        			...
			                        			<c:otherwise>
			                        				 <li class="PagedList-skipToNext">
			                        				<a href="${pageContext.request.contextPath}/servicesCategoryAction_list.action?currentPage=${currentPage+1}" rel="next">>></a>
			                        				</li>
			                        			</c:otherwise>
			                        		</c:choose>
