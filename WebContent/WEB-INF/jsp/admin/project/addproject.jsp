...
<body>
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/projectAction_add"  enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>案例信息添加</strong> </h3>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="zxName" name="project.projectName"/>
                                            </div>
									...
									<div class="form-group">
                                        <label class="col-md-2 col-xs-12 control-label">发布日期</label>
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                <input type="text" id="mydate" class="form-control datepicker"  name="project.projectDate">
                                            </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            ...
                                            <span class="help-block" style="display: none;color: red" id="info_lable">请输入案例信息内容！</span>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
			...
			var cdate = "";
            var myDate = new Date();
            cdate = cdate+myDate.getFullYear()+"-";    //获取完整的年份(4位,1970-????)
            cdate = cdate+(myDate.getMonth()+1)+"-";       //获取当前月份(0-11,0代表1月)
            cdate = cdate+ myDate.getDate();        //获取当前日(1-31)
			$("#mydate").val(cdate);
