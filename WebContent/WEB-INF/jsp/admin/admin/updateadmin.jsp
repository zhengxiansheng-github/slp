...
<body>
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" action="${pageContext.request.contextPath}/adminAction_update" onsubmit="return checkdata()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" readonly="readonly" id="adminName" name="admin.adminName" value="${admin.adminName }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" id="ypwd" name="password"/>
                                            </div>
    ...
    <script>
        ...
        function checkdata(){
       		var name = $("#ypwd").val();
       		if(name!="${sessionScope.admin.password}"){
       			$("#ypwd_lable").show();
       			return false;
       		}
       		var pwd = $("#pwd").val();
