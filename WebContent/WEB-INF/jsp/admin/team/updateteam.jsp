            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/teamAction_update"  enctype="multipart/form-data">
                                <input type="hidden" name="team.id" value="${team.id }">
                            	<input type="hidden" name="team.photo" value="${team.photo }"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="tName" name="team.name" value="${team.name }"/>
                                            </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" id="tjob" name="team.position" value="${team.position }"/>
                                            </div>
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片"  none" id="searchImage" name="fileImage" style="display: none;"/>
                                           		  ...
                                           		  <br/><img src="${pageContext.request.contextPath}/upload/${team.photo }" id="img0" width="240" height="100" >
                                            </div>
