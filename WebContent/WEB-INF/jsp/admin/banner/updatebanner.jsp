            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/bannerAction_update"  enctype="multipart/form-data">
                           <input type="hidden" name="banner.id" value="${banner.id }">
                           <input type="hidden" name="banner.bannerImg" value="${banner.bannerImg }"/>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>编辑Banner信息</strong> </h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="bannerName" name="banner.name" value="${banner.name }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="urlImage" name="banner.url" value="${banner.url }"/>
                                            </div>
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片" style="display: none" id="searchImage" name="fileImage"/>
                                           		  ...
                                           		  <br/><img src="<%-- ${pageContext.request.contextPath}/upload/${banner.bannerImg } --%>" id="img0" width="240" height="100" >
                                            </div>
